...
pub fn apic_local_init() {
    // UEFI firmware already initialized Local APIC during boot
    // We only ensure the LAPIC is enabled (bit 8 of SVR)
    unsafe {
